...
import ch01.P01_CountDuplicateCharacters.P01_CountDuplicateCharacters;
...
public class P01_CountDuplicateCharactersTest {
    ...
    public void testCountDuplicateCharacters() {
        ...
        Map<Character, Integer> duplicatesV1 = P01_CountDuplicateCharacters.countDuplicateCharactersV1(TEXT);
        ...
        Map<Character, Long> duplicatesV2 = P01_CountDuplicateCharacters.countDuplicateCharactersV2(TEXT);
        ...
        Map<String, Integer> duplicatesV3 = P01_CountDuplicateCharacters.countDuplicateCharactersVCP1(TEXT_CP);
        ...
        Map<String, Long> duplicatesV4 = P01_CountDuplicateCharacters.countDuplicateCharactersVCP2(TEXT_CP);
