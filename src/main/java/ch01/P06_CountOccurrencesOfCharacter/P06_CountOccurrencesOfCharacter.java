package ch01.P06_CountOccurrencesOfCharacter;

public final class P06_CountOccurrencesOfCharacter {

    private P06_CountOccurrencesOfCharacter() {
    ...
    public static void main(String[] args) {
        String str = "some strange string";
        countOccurrencesOfACertainCharacterV1(str, 's');
        countOccurrencesOfACertainCharacterV2(str, 's');
        countOccurrencesOfACertainCharacterVCP1(str, "s");
        countOccurrencesOfACertainCharacterVCP2(str, "s");
        countOccurrencesOfACertainCharacterVCP3(str, "s");
    }
}
