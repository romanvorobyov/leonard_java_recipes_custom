package ch07.P149_InspectPackages;
...
public class P149_InspectPackages {

    private static final Logger logger = Logger.getLogger(P149_InspectPackages.class.getName());
    ...
    public static void main(String[] args) 
        ...
        P149_InspectPackages main = new P149_InspectPackages();
