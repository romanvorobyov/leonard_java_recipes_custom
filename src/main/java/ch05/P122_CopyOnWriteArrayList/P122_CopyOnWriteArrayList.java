package ch05.P122_CopyOnWriteArrayList;
...
public class P122_CopyOnWriteArrayList { // ThreadSafeList {

    private static final Logger logger = Logger.getLogger(P122_CopyOnWriteArrayList.class.getName());
