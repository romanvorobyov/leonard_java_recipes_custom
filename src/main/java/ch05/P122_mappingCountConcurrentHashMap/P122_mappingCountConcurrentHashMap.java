package ch05.P122_mappingCountConcurrentHashMap;
...
public final class P122_mappingCountConcurrentHashMap { // MappingCount {

    private P122_mappingCountConcurrentHashMap() {
        throw new AssertionError("Cannot be instantiated");
    }

    private static final Logger logger = Logger.getLogger(P122_mappingCountConcurrentHashMap.class.getName());
