package ch05.P122_PriorityBlockingQueue;
...
public class P122_PriorityBlockingQueue {// ThreadSafeQueue {

    private static final Logger logger = Logger.getLogger(P122_PriorityBlockingQueue.class.getName());
