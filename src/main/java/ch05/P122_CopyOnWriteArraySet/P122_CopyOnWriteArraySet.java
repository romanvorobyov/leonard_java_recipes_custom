package ch05.P122_CopyOnWriteArraySet;
...
public class P122_CopyOnWriteArraySet { // ThreadSafeSet {

    private static final Logger logger = Logger.getLogger(P122_CopyOnWriteArraySet.class.getName());
