package ch05.P122_SynchronousQueue;
...
public class P122_SynchronousQueue {// ThreadSafeQueue {

    private static final Logger logger = Logger.getLogger(P122_SynchronousQueue.class.getName());
