package ch05.P122_ConcurrentHashMap;
...
public class P122_ConcurrentHashMap { //ThreadSafeMap {

    private static final Logger logger = Logger.getLogger(P122_ConcurrentHashMap.class.getName());
