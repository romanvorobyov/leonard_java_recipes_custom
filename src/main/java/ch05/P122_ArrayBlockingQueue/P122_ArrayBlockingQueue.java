package ch05.P122_ArrayBlockingQueue;
...
public class P122_ArrayBlockingQueue {// ThreadSafeQueue {

    private static final Logger logger = Logger.getLogger(P122_ArrayBlockingQueue.class.getName());
