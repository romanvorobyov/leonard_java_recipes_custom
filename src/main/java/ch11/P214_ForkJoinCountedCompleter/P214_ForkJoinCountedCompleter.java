package ch11.P214_ForkJoinCountedCompleter;
...
public class P214_ForkJoinCountedCompleter {

    private static final Logger logger = Logger.getLogger(P214_ForkJoinCountedCompleter.class.getName());
