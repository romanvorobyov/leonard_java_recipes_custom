package ch11.P213_ThreadInterruption;
...
public class P213_ThreadInterruption {

    private static final Logger logger = Logger.getLogger(P213_ThreadInterruption.class.getName());
