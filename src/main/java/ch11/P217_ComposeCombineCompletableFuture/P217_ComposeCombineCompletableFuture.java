package ch11.P217_ComposeCombineCompletableFuture;
...
public class P217_ComposeCombineCompletableFuture {

    private static final Logger logger = Logger.getLogger(P217_ComposeCombineCompletableFuture.class.getName());
