package ch11.P214_ForkJoinFibonacci;

import java.util.concurrent.ForkJoinPool;
import java.util.logging.Logger;

public class P214_ForkJoinFibonacci {

    private static final Logger logger = Logger.getLogger(P214_ForkJoinFibonacci.class.getName());
