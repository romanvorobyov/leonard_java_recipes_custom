package ch11.P215_compareAndSetForkJoinTaskTag;
...
public class P215_compareAndSetForkJoinTaskTag {

    private static final Logger logger = Logger.getLogger(P215_compareAndSetForkJoinTaskTag.class.getName());
