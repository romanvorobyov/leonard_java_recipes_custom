package ch11.P216_CompletableFuture;

import java.util.concurrent.CompletableFuture;
import java.util.concurrent.ExecutionException;
import java.util.logging.Logger;

public class P216_CompletableFuture {

    private static final Logger logger = Logger.getLogger(P216_CompletableFuture.class.getName());
